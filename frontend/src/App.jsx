...
const componentStyles = `@import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600;700&family=Inter:wght@300;400;500;600;700&display=swap');

/* ══════════════════════════════════════════════
   DESIGN SYSTEM — English Luxury × Clean White
   Primary: Navy #0F2D52  Accent: Gold #C9A84C
══════════════════════════════════════════════ */
:root {
  /* Core palette */
  --navy:          #0F2D52;
  ...
  --text-light:    #6B7280;
  --text-muted:    #9CA3AF;
  --secondary: #1A3F70;  /* compat alias */

  /* Shadows */
  --shadow-xs:  0 1px 2px rgba(15,45,82,0.04);
  --shadow-sm:  0 2px 8px rgba(15,45,82,0.06);
  --shadow:     0 4px 24px rgba(15,45,82,0.08);
  --shadow-md:  0 8px 32px rgba(15,45,82,0.10);
  --shadow-lg:  0 16px 48px rgba(15,45,82,0.12);
  --shadow-xl:  0 24px 64px rgba(15,45,82,0.16);
...
.badge-rent     { background: #EFF6FF; color: #1E40AF; border: 1px solid #BFDBFE; }
...
.badge-sold     { background: #FEF2F2; color: #991B1B; border: 1px solid #FECACA; }
.badge-rented   { background: #EFF6FF; color: #1E40AF; border: 1px solid #BFDBFE; }
.badge-featured { background: var(--gold-pale); color: var(--warning); border: 1px solid var(--gold-light); }
...
.btn-gold:hover:not(:disabled) {
  background: #B8973D; transform: translateY(-1px);
...
.btn-white:hover:not(:disabled) { background: var(--off-white); transform: translateY(-1px); }

.btn-danger  { background: var(--danger); color: white; border-color: var(--danger); }
.btn-danger:hover:not(:disabled)  { background: #991B1B; }
.btn-success { background: var(--success); color: white; border-color: var(--success); }
.btn-success:hover:not(:disabled) { background: #15653D; }
...
.divider-gold { height: 2px; background: linear-gradient(90deg, transparent, var(--gold), transparent); }
...
.page-loader { display: flex; align-items: center; justify-content: center; min-height: 400px; }
...
.modal-close  { background: none; border: none; font-size: 20px; cursor: pointer; color: var(--text-muted); line-height: 1; padding: 4px; border-radius: 6px; }
